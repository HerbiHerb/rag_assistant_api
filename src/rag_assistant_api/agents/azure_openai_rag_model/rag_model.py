...
def initialize_rag_model(model_name: str, embedding_model: str):
    ...
    document_search_tool = DocumentSearch(embedding_model=embedding_model, database_handler=database_handler)
    rag_agent = AzureOpenAIRAGModel(model_name=model_name, search_tool=document_search_tool)
    return rag_agent
